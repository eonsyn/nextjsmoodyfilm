...
export default function About() {
  return (
    <>
      <Head>
        <title>About Moodyfilm - Your Ultimate Movie Destination</title>
        <meta
          name="description"
          content="Discover Moodyfilm, your go-to platform for downloading and streaming movies. Enjoy AI-based movie recommendations and retro-styled themes for a nostalgic experience."
        />
        <meta
          name="keywords"
          content="Moodyfilm, movie downloads, watch movies online, AI movie recommendations, retro movies, film reviews, best movie site"
        />
        <meta name="author" content="Moodyfilm Team" />
      ...
      <div className="min-h-screen   p-6 text-white">
        <div className=" w-full shadow-xl rounded-2xl p-8">
          ...
          <p className="text-lg text-gray-300 text-center leading-relaxed">
            Welcome to{" "}
            <span className="text-blue-400 font-semibold">Moodyfilm</span> –
            your ultimate movie destination! We offer a seamless experience for
          ...
          <div className="mt-8 space-y-6">
            ...
            <div className="p-4 bg-white/20 rounded-xl shadow-md">
              ...
              <p className="text-gray-300 mt-2">
                Engage with fellow movie lovers, share reviews, and explore
                hidden gems. Follow us for updates on the latest releases and
                special features!
              </p>
            </div>
          </div>
