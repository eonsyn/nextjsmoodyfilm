...
export default function Contact() {
  ...
  return (
    <>
      <Head>
        <title>Contact Us - Moodyfilm</title>
        <meta
          name="description"
          content="Get in touch with Moodyfilm for support, feedback, or partnership inquiries. We’d love to hear from you!"
        />
        <meta
          name="keywords"
          content="Moodyfilm contact, support, movie inquiries, feedback, partnership"
        />
      ...
      <div className="min-h-screen flex flex-col items-center justify-center p-6 text-white">
        <div className="max-w-2xl w-full bg-white/10 backdrop-blur-lg border border-white/20 shadow-xl rounded-2xl p-8">
          ...
          <p className="text-lg text-gray-300 text-center mb-6">
            ...
            form below or reach us through our support channels.
          </p>
